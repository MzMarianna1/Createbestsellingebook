(() => {
  ...
  const css = `
    ...
    .lk-proof-grid-v3{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-top:28px}
    ...
    #lk-buyer-fit-v3{padding:56px 24px;background:#fff;color:var(--lk-ink);border-bottom:1px solid rgba(95,56,148,.1)}
    ...
    #lk-trust-v3{padding:60px 24px 64px;background:var(--lk-lavender);color:var(--lk-ink)}
    ...
    #lk-assessment{height:auto!important;min-height:0!important;padding:64px 24px!important;background:radial-gradient(circle at 10% 12%,rgba(226,184,63,.14),transparent 28%),linear-gradient(145deg,#24102f 0%,var(--lk-deep) 56%,var(--lk-purple) 100%)!important}
    #lk-assessment .comp-msij8949-container{position:relative!important;height:auto!important;min-height:0!important;display:grid!important;grid-template-columns:minmax(260px,360px) minmax(480px,620px)!important;grid-template-rows:auto!important;column-gap:54px!important;align-items:start!important;justify-content:center!important}
    #comp-msijsmo2,#comp-msijvz8b,#comp-msij9nuo{inset:auto!important;transform:none!important;margin:0!important;max-width:none!important;align-self:start!important;justify-self:stretch!important}
    #comp-msijsmo2,#comp-msijvz8b{position:absolute!important;left:0!important;right:auto!important;width:360px!important;z-index:1}
    ...
    @media(max-width:750px){#lk-assessment{grid-column:1!important;grid-row:1/2!important}#comp-msy268o9{grid-column:1!important;grid-row:8/9!important}#SITE_CONTAINER #main_MF#main_MF .css-editing-scope #lk-assessment.wixui-lk-assessment-section>[data-testid='responsive-container-content']>#comp-msijsmo2{grid-row:1!important}#SITE_CONTAINER #main_MF#main_MF .css-editing-scope #lk-assessment.wixui-lk-assessment-section>[data-testid='responsive-container-content']>#comp-msijvz8b{grid-row:2!important}#SITE_CONTAINER #main_MF#main_MF .css-editing-scope #lk-assessment.wixui-lk-assessment-section>[data-testid='responsive-container-content']>#lk-assessment-benefits-v3{grid-row:3!important}#SITE_CONTAINER #main_MF#main_MF .css-editing-scope #lk-assessment.wixui-lk-assessment-section>[data-testid='responsive-container-content']>#comp-msij9nuo{grid-row:4!important}}
