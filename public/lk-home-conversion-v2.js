(() => {
  ...
  const css = `
    ...
    @media(max-width:750px){#SITE_CONTAINER #main_MF#main_MF .css-editing-scope #lk-assessment.wixui-lk-assessment-section>[data-testid='responsive-container-content']>#comp-msijsmo2{grid-row:1!important}#SITE_CONTAINER #main_MF#main_MF .css-editing-scope #lk-assessment.wixui-lk-assessment-section>[data-testid='responsive-container-content']>#comp-msijvz8b{grid-row:2!important}#SITE_CONTAINER #main_MF#main_MF .css-editing-scope #lk-assessment.wixui-lk-assessment-section>[data-testid='responsive-container-content']>#lk-assessment-benefits-v3{grid-row:3!important}#SITE_CONTAINER #main_MF#main_MF .css-editing-scope #lk-assessment.wixui-lk-assessment-section>[data-testid='responsive-container-content']>#comp-msij9nuo{grid-row:4!important}}
